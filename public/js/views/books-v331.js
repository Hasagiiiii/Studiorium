        ...
        <article class="book-detail-layout">
          ...
          <div class="book-detail-copy">
            ...
            <p class="book-detail-description">
              ${E(book.description || 'A comunidade ainda não adicionou uma descrição para esta obra.')}
            </p>
            ...
            <div class="book-detail-actions">
              ...
              <button class="soft" type="button" data-book-save="${E(book.id)}:reading">Lendo</button>
              <button class="outline" type="button" data-book-save="${E(book.id)}:read">Já li</button>
      ...
      <div class="shell">
        ...
        <div class="book-detail-reviews">
          ${reviews.length
            ? reviews
                .map(
                  (review) => html`<article class="card book-detail-review">
