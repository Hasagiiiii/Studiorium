      ...
      <details class="workspace-profile-option">
        ...
        <div class="workspace-settings-pane workspace-media-grid">
          ${mediaEditor(
            ...
            'avatar',
            'Foto de perfil',
            'Escolha uma foto do celular ou computador. Ela será otimizada automaticamente antes do envio.',
          )}
          ${mediaEditor(
            user,
            'cover',
            'Foto de capa',
            'Use uma imagem horizontal. Ela será otimizada e seguirá a privacidade do seu perfil.',
          )}
        </div>
      </details>
