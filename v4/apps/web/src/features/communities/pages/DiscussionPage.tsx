...
export function DiscussionPage() {
  ...
  return (
    <FeaturePage
      ...
      description={`${discussion.replyCount} ${discussion.replyCount === 1 ? 'resposta' : 'respostas'}`}
    >
        ...
        <main className="discussion-thread">
          ...
          <article className="discussion-topic-card">
            ...
            <footer className="discussion-topic-footer">
              ...
              <span>
                {discussion.status === 'published' ? 'Discussão aberta' : discussion.status}
              </span>
            </footer>
          </article>

          <section
            className="discussion-replies-placeholder"
          ...
          >
            ...
            <p>
              {discussion.replyCount
                ? 'Abra esta conversa novamente após as respostas serem carregadas para acompanhar a discussão completa.'
                : 'Ainda não há respostas. Seja a primeira pessoa a continuar esta conversa.'}
            </p>
          </section>
        </main>
        ...
        <aside className="discussion-context" aria-label="Contexto da discussão">
          <section>
            ...
            <dl>
              <div>
                <dt>Categoria</dt>
                <dd>{discussion.category}</dd>
              </div>
              <div>
                <dt>Autor</dt>
                <dd>{discussion.authorName}</dd>
              </div>
              <div>
                <dt>Respostas</dt>
                <dd>{discussion.replyCount}</dd>
              </div>
              <div>
                <dt>Status</dt>
                <dd>{discussion.status === 'published' ? 'Aberto' : discussion.status}</dd>
              </div>
            </dl>
          </section>
          <section>
            ...
            <p>
              Responda ao argumento, mantenha o tópico em contexto e use a denúncia para conteúdo
              que viole as regras.
            </p>
          </section>
        </aside>
